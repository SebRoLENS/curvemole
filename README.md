...
> **Status:** Version **0.28.6 Preview**. The scientific core and desktop workflow
...
Version **0.28.6** will be archived on Zenodo after its GitHub integration is enabled.
...
> [Computer software]. GitHub. https://github.com/SebRoLENS/curvemole/releases/tag/v0.28.6
