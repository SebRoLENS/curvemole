...
Version **0.24.2** will be archived on Zenodo after its GitHub integration is enabled.
...
> [Computer software]. GitHub. https://github.com/SebRoLENS/curvemole/releases/tag/v0.24.2
