...
Version **0.12.4** will be archived on Zenodo after its GitHub integration is enabled.
...
> [Computer software]. GitHub. https://github.com/SebRoLENS/curvemole/releases/tag/v0.12.4
