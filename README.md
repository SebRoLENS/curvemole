...
Version **0.14.0** will be archived on Zenodo after its GitHub integration is enabled.
...
> [Computer software]. GitHub. https://github.com/SebRoLENS/curvemole/releases/tag/v0.14.0
