...
> **Status:** Version **0.2.0 Preview**. The scientific core and desktop workflow
...
Version **0.2.0** will be archived on Zenodo after its GitHub integration is enabled.
The release DOI will then be inserted here automatically.

> Romi, S. (2026). *CurveMole: Modular Scientific Curve Fitting* (Version 0.2.0)
> [Computer software]. GitHub. https://github.com/SebRoLENS/curvemole/releases/tag/v0.2.0
