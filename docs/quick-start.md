...
to frame all experimental samples, including masked regions. **View unmasked**,
...
offsets and visual background subtraction. With no usable samples, View unmasked
