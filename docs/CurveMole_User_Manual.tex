...
\begin{Shaded}
\begin{Highlighting}[]
\VariableTok{APPIMAGE\_EXTRACT\_AND\_RUN=}\NormalTok{1 }\ExtensionTok{./CurveMole{-}0.2.1{-}linux{-}x86\_64.AppImage}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{shasum}\NormalTok{ {-}a 256 CurveMole{-}0.2.1{-}macos{-}arm64.dmg}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Get{-}FileHash .\textbackslash{}CurveMole{-}0.}\FunctionTok{2}\NormalTok{.}\FunctionTok{1}\NormalTok{{-}windows{-}x86\_64.}\FunctionTok{exe}\NormalTok{ {-}Algorithm SHA256}
\end{Highlighting}
\end{Shaded}
...
\ExtensionTok{python}\NormalTok{ {-}m pip install ./curvemole{-}0.2.1{-}py3{-}none{-}any.whl}
...
\NormalTok{python {-}m pip install .\textbackslash{}curvemole{-}0.}\FunctionTok{2}\NormalTok{.}\FunctionTok{1}\NormalTok{{-}py3{-}none{-}any.}\FunctionTok{whl}
...
\begin{longtable}[]{@{}ll@{}}
\toprule
Column & Meaning\tabularnewline
\midrule
\endhead
Parameter & Parameter name; linked parameters show a link
indicator\tabularnewline
Value & Current value or successful fitted value\tabularnewline
±1 sigma & Covariance-based standard error when available\tabularnewline
Fixed & Exclude the parameter from optimization\tabularnewline
Lower & Lower bound; blank means negative infinity\tabularnewline
Upper & Upper bound; blank means positive infinity\tabularnewline
Link & Restricted expression controlling this parameter\tabularnewline
\bottomrule
\end{longtable}
