...
\renewcommand{\maketitle}{%
  \begin{titlepage}
    ...
    \vspace{0.45cm}
    {\sffamily\Large\color{CurveMoleGrey}Preview 0.28.9\par}
    \vspace{0.55cm}
...
\makeatother
\subtitle{Preview 0.28.9}
\author{Sebastiano Romi}
\date{Updated for CurveMole 0.28.9}
...
CurveMole 0.28.9 Preview. The Markdown file is the authoritative source.
The LaTeX source and PDF edition are generated automatically from it and
must carry the same version number.

\begin{quote}
\textbf{Preview status.} CurveMole 0.28.9 is suitable for evaluation and
...
an independent document version. For example, a manual marked 0.28.9
describes CurveMole 0.28.9.
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{chmod}\NormalTok{ +x CurveMole{-}0.28.9{-}linux{-}x86\_64.AppImage}
\ExtensionTok{./CurveMole{-}0.28.9{-}linux{-}x86\_64.AppImage}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\VariableTok{APPIMAGE\_EXTRACT\_AND\_RUN=}\NormalTok{1 }\ExtensionTok{./CurveMole{-}0.28.9{-}linux{-}x86\_64.AppImage}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{shasum}\NormalTok{ {-}a 256 CurveMole{-}0.28.9{-}macos{-}arm64.dmg}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Get{-}FileHash .\textbackslash{}CurveMole{-}0.}\FunctionTok{28}\NormalTok{.}\FunctionTok{9}\NormalTok{{-}windows{-}x86\_64{-}setup.}\FunctionTok{exe}\NormalTok{ {-}Algorithm SHA256}
\end{Highlighting}
\end{Shaded}
...
\ExtensionTok{python}\NormalTok{ {-}m pip install ./curvemole{-}0.28.9{-}py3{-}none{-}any.whl}
...
\NormalTok{python {-}m pip install .\textbackslash{}curvemole{-}0.}\FunctionTok{28}\NormalTok{.}\FunctionTok{9}\NormalTok{{-}py3{-}none{-}any.}\FunctionTok{whl}
...
project but is not used by the version 0.28.9 optimizer.
...
Preview 0.28.9 does not yet provide a single comprehensive on-screen
...
(Version 0.28.9) {[}Computer software{]}. GitHub.
...
\hypertarget{appendix-d.-preview-0.28.9-limitations}{%
\chapter{Appendix D. Preview 0.28.9
limitations}\label{appendix-d.-preview-0.28.9-limitations}}
