...
Click the assessment to read its explicit reasons, including the names and
...
Attention\strut
\end{minipage} & \begin{minipage}[t]{0.47\columnwidth}\raggedright
Bound contact, strong correlation, failed
...
wrong. Click the assessment to see why it is flagged; no color
