...
\begin{Shaded}
\begin{Highlighting}[]
\VariableTok{APPIMAGE\_EXTRACT\_AND\_RUN=}\NormalTok{1 }\ExtensionTok{./CurveMole{-}0.28.8{-}linux{-}x86\_64.AppImage}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{shasum}\NormalTok{ {-}a 256 CurveMole{-}0.28.8{-}macos{-}arm64.dmg}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Get{-}FileHash .\textbackslash{}CurveMole{-}0.}\FunctionTok{28}\NormalTok{.}\FunctionTok{8}\NormalTok{{-}windows{-}x86\_64{-}setup.}\FunctionTok{exe}\NormalTok{ {-}Algorithm SHA256}
\end{Highlighting}
\end{Shaded}
...
\ExtensionTok{python}\NormalTok{ {-}m pip install ./curvemole{-}0.28.8{-}py3{-}none{-}any.whl}
...
\NormalTok{python {-}m pip install .\textbackslash{}curvemole{-}0.}\FunctionTok{28}\NormalTok{.}\FunctionTok{8}\NormalTok{{-}py3{-}none{-}any.}\FunctionTok{whl}
...
OK\strut
\end{minipage} & \begin{minipage}[t]{0.47\columnwidth}\raggedright
Interval meets your absolute precision target and no diagnostic issue is
flagged\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.47\columnwidth}\raggedright
Not assessed\strut
\end{minipage} & \begin{minipage}[t]{0.47\columnwidth}\raggedright
No precision target is set; scientific adequacy cannot be inferred\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.47\columnwidth}\raggedright
Attention\strut
\end{minipage} & \begin{minipage}[t]{0.47\columnwidth}\raggedright
Bound contact, strong correlation, insufficient precision, failed
replicates, an open profile scan, or another stated caveat\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.47\columnwidth}\raggedright
Critical\strut
\end{minipage} & \begin{minipage}[t]{0.47\columnwidth}\raggedright
